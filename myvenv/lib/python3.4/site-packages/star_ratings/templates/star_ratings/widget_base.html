...
if(athehieght<0)
{
    var tempval=(Number(athehieght)*(-1));
    variablewd=1+tempval;
    variablewu=2-variablewd;
    variablewd=(variablewd/2)*100;
    variablewu=100-variablewd;
}
if(athehieght>0)
{
    variablewu=1+Number(athehieght);
    variablewd=2-variablewu;
    variablewu=(variablewu/2)*100;
